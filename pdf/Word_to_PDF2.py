...
def concatenate_two_documents():
    ...
    with open(rf'C:\Users\Sereja\Desktop\pdf\0.pdf', "rb") as pdf_file_handle:
        input_pdf_001 = PDF.loads(pdf_file_handle)

    # Прочитайте второй PDF-файл
    with open(rf'C:\Users\Sereja\Desktop\pdf\1.pdf', "rb") as pdf_file_handle:
    ...
    # Написать PDF
    with open(rf'C:\Users\Sereja\Desktop\pdf\Big.pdf', "wb") as pdf_out_handle:
